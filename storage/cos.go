...
func GetCosStsCredential(config conf.Cos, bucketName, appid, region, openid, fileExt string) (*sts.CredentialResult, error) {
	...
	// source := "qcs::cos:" + region + ":uid/" + appid + ":" + bucketName + "/" + openid + ".jpg"
